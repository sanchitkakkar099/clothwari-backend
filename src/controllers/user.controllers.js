...
exports.adminlogin = async (req, res) => {
    try {
        ...
        if (userCheck && userCheck.role == UserRoleConstant.Client) {
            ...
            else return res.status(HttpStatus.BAD_REQUEST).send(helperUtils.errorRes("Session Expired Please Contact Administrator", {}, HttpStatus.BAD_REQUEST));
        }
